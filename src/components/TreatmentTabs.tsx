...
const TABS = [
  { href: "/treatments", label: "Catalog" },
  { href: "/treatments/plans", label: "Treatment Plans" },
  { href: "/treatments/progress", label: "Progress Tracker" },
];
...
export default function TreatmentTabs() {
  ...
  function isActive(href: string) {
    if (href === "/treatments") return pathname === "/treatments";
