...
const DEPARTMENTS = [
  ...
  "Balachikitsa", "Shalakya Tantra", "Shalya Tantra", "Rasayana",
];
          ...
          <div className="hidden md:block overflow-hidden" style={cardStyle}>
            <table className="w-full" role="table">
              <thead style={{ borderBottom: "1px solid var(--grey-300)", background: "var(--grey-50)" }}>
                <tr>
                  <SortHeader label="Doctor" field="name" currentField={sortField} direction={sortDir} onSort={handleSort} />
