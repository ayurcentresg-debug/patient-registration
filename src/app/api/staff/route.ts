          ...
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px;">
              <div style="text-align: center; margin-bottom: 24px;">
                <div style="display: inline-block; width: 48px; height: 48px; background: #92400e; border-radius: 12px; line-height: 48px; color: white; font-weight: bold; font-size: 18px;">AC</div>
              </div>
              <h2 style="color: #92400e; margin-bottom: 8px; text-align: center;">Welcome to Ayur Centre</h2>
              ...
              <div style="text-align: center; margin: 24px 0;">
                <a href="${inviteUrl}" style="display: inline-block; background: #92400e; color: white; padding: 12px 32px; border-radius: 8px; text-decoration: none; font-weight: bold; font-size: 14px;">Set Your Password</a>
              </div>
