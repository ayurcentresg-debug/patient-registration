...
export async function PUT(
  ...
  try {
    ...
    if (body.branchRestricted !== undefined) updateData.branchRestricted = !!body.branchRestricted;
    if (body.branchSchedules !== undefined) updateData.branchSchedules = body.branchSchedules || null;
