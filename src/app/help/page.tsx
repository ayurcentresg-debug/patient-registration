...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: "PWA — install to home screen + offline mode", description: "AyurGate is a Progressive Web App. Install it to your phone's home screen for an app-like experience. App shell + recently-visited pages stay accessible even when offline. Red banner appears at the top when connection drops.", howTo: "Mobile: Add to Home Screen from browser menu · Desktop Chrome/Edge: ⊕ icon in address bar" },
