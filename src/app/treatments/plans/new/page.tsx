...
export default function NewTreatmentPlanPage() {
  ...
  async function handleSubmit(status: "active" | "draft") {
    ...
    try {
      ...
      setTimeout(() => router.push("/treatments/plans"), 600);
    } catch (err) {
  ...
  return (
    <div className="p-6 md:p-8 yoda-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <button onClick={() => router.push("/treatments/plans")} className="inline-flex items-center gap-2 px-4 py-2 text-[13px] font-semibold rounded" style={{ ...inputStyle, color: "var(--grey-700)" }}>
      ...
      <div className="mb-6 p-5" style={cardStyle}>
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={addItem} className="inline-flex items-center gap-1 px-3 py-1.5 text-[12px] font-semibold rounded text-white" style={{ background: "var(--blue-500)", borderRadius: "var(--radius-sm)" }}>
      ...
      <div className="mb-6 p-5" style={cardStyle}>
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={addMilestone} className="inline-flex items-center gap-1 px-3 py-1.5 text-[12px] font-semibold rounded text-white" style={{ background: "var(--blue-500)", borderRadius: "var(--radius-sm)" }}>
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" /></svg>
            Add Milestone
          </button>
        </div>
      ...
      <div className="flex flex-col sm:flex-row justify-end gap-3 mb-8">
        ...
        <button
          ...
          style={{ background: "var(--blue-500)", borderRadius: "var(--radius-sm)", opacity: submitting ? 0.6 : 1, cursor: submitting ? "not-allowed" : "pointer" }}
        >
