    ...
    <div className="p-6 md:p-8 yoda-fade-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="p-4 transition-shadow duration-150 hover:shadow-md cursor-pointer" style={{ ...cardStyle, boxShadow: "var(--shadow-sm)", borderLeft: "4px solid var(--orange)" }} onClick={() => toggleSection("expiringSoon")}>
          <p className="text-[14px] font-semibold uppercase tracking-wide" style={{ color: "var(--orange)" }}>Expiring Soon</p>
                    ...
                    <table className="w-full">
                      <thead style={{ borderBottom: "1px solid var(--grey-200)", background: "var(--grey-50)" }}>
                        <tr>
                          ...
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Category</th>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Current Stock</th>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Reorder Level</th>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Shortage</th>
                          <th className="text-right px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Action</th>
                        </tr>
                      </thead>
                      <tbody>
                    ...
                    <table className="w-full">
                      <thead style={{ borderBottom: "1px solid var(--grey-200)", background: "var(--grey-50)" }}>
                        <tr>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Item Name</th>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>SKU</th>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Batch</th>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Stock</th>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Expiry Date</th>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Days Left</th>
                          <th className="text-right px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        {alerts.expiringSoon.map((item, i) => {
                          ...
                          return (
                            <tr key={item.id} style={{ borderBottom: i < alerts.expiringSoon.length - 1 ? "1px solid var(--grey-200)" : "none" }}>
                              ...
                              <td className="px-4 py-3 text-[14px]" style={{ color: "var(--grey-700)" }}>{item.expiryDate ? formatDate(item.expiryDate) : "\u2014"}</td>
                              <td className="px-4 py-3">
                    ...
                    {alerts.expiringSoon.map((item) => {
                      ...
                      return (
                        <div key={item.id} className="p-4 space-y-2">
                          ...
                          <button onClick={() => handleMarkExpired(item)} disabled={actionLoading === item.id} className="inline-flex px-3 py-1.5 text-[13px] font-semibold disabled:opacity-50" style={{ borderRadius: "var(--radius-sm)", background: "#fef2f2", color: "var(--red)", border: "1px solid #fecaca" }}>
                            {actionLoading === item.id ? "..." : "Mark Expired"}
                          </button>
                        </div>
                      );
                    ...
                    <table className="w-full">
                      <thead style={{ borderBottom: "1px solid var(--grey-200)", background: "var(--grey-50)" }}>
                        <tr>
                          ...
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Stock</th>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Expiry Date</th>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Days Overdue</th>
                          <th className="text-right px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        {alerts.expired.map((item, i) => {
                          ...
                          return (
                            <tr key={item.id} style={{ borderBottom: i < alerts.expired.length - 1 ? "1px solid var(--grey-200)" : "none" }}>
                              ...
                              <td className="px-4 py-3 text-[14px]" style={{ color: "var(--grey-700)" }}>{item.batchNumber || "\u2014"}</td>
                              <td className="px-4 py-3 text-[15px] font-semibold" style={{ color: "var(--grey-900)" }}>{item.currentStock} {item.unit}</td>
                              <td className="px-4 py-3 text-[14px]" style={{ color: "var(--red)" }}>{item.expiryDate ? formatDate(item.expiryDate) : "\u2014"}</td>
                              <td className="px-4 py-3">
                    ...
                    {alerts.expired.map((item) => {
                      ...
                      return (
                        <div key={item.id} className="p-4 space-y-2">
                          ...
                          <button onClick={() => handleWriteOff(item)} disabled={actionLoading === item.id} className="inline-flex px-3 py-1.5 text-[13px] font-semibold text-white disabled:opacity-50" style={{ borderRadius: "var(--radius-sm)", background: "var(--red)" }}>
                            {actionLoading === item.id ? "..." : "Write Off"}
                          </button>
                        </div>
                      );
                    ...
                    <table className="w-full">
                      <thead style={{ borderBottom: "1px solid var(--grey-200)", background: "var(--grey-50)" }}>
                        <tr>
                          ...
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Category</th>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Reorder Level</th>
                          <th className="text-left px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Last Transaction</th>
                          <th className="text-right px-4 py-2.5 text-[13px] font-bold uppercase tracking-wider" style={{ color: "var(--grey-600)" }}>Action</th>
                        </tr>
                      </thead>
                      <tbody>
